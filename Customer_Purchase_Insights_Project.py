...
def perform_numpy_analysis(df):
    ...
    mean_values = np.min(matrix, axis=0)
...
def analyze_statistics(df):
    ...
    print("Total Store Revenue: ${:.2f}".format(total_revenue))
    print("Average Order Value: ${:.2f}".format(avg_spent))
    print("Top Spending Customer: {}".format(best_customer))
